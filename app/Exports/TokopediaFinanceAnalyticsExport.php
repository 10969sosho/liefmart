...
class TokopediaFinanceAnalyticsExport extends DefaultValueBinder implements FromQuery, WithHeadings, WithMapping, WithStyles, ShouldAutoSize, WithCustomValueBinder
{
    protected $request;
    ...
    {
        $query = TokopediaFinancialTransaction::select([
    ...
    public function map($transaction): array
    {
        ...
        return [
            ...
            $transaction->nominal_diskon1 ?? 0, // KOMISI
            $transaction->nominal_diskon2 ?? 0, // BIAYA LAYANAN
            $transaction->nominal_diskon3 ?? 0, // BIAYA ADMIN
            $transaction->nominal_diskon4 ?? 0, // ONGKIR
