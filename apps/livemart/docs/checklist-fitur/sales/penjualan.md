...
Modul pencatatan transaksi penjualan online (Marketplace: Shopee Lamourad, Shopee Liefmarket, Tiktok Lamourad, Tiktok Liefmarket).
...
- [ ] **Shopee Lamourad**: Test input manual & import file Shopee.
- [ ] **Shopee Liefmarket**: Test input manual & import file Shopee Liefmarket.
- [ ] **Tiktok Lamourad**: Test input manual & import file TikTok.
- [ ] **Tiktok Liefmarket**: Test input manual & import file Tiktok Liefmarket.
