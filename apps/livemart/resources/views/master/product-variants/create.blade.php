...
<div class="container-fluid py-4">
    <div class="ds-page-header">
        <h1 class="text-gradient">Tambah Varian Produk</h1>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="{{ route('product-variants.index') }}">Varian Produk</a></li>
        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="ds-card-header">
                    <h6>Tambah Varian Produk Baru</h6>
                </div>
                <div class="card-body">
                    @if ($errors->any())
