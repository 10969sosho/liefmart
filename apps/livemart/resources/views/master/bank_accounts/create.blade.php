...
<div class="container-fluid">
    <div class="ds-page-header">
        <h1 class="text-gradient">Tambah Rekening Bank</h1>
            ...
            <div class="card mb-4">
                <div class="ds-card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">
                            <i class="fas fa-university text-primary mr-2"></i> Tambah Rekening Bank
                        </h5>
                ...
                <div class="card-body">
                    <form action="{{ route('bank-accounts.store') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group d-none" id="other_bank_group">
                                    ...
                                    <input type="text" class="form-control" id="other_bank" placeholder="Masukkan nama bank">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('account_number') is-invalid @enderror" id="account_number" name="account_number" value="{{ old('account_number') }}" placeholder="Contoh: 1234567890" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('account_name') is-invalid @enderror" id="account_name" name="account_name" value="{{ old('account_name') }}" placeholder="Nama pemilik rekening" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" rows="3" placeholder="Contoh: Rekening operasional untuk penerimaan pembayaran customer">{{ old('description') }}</textarea>
