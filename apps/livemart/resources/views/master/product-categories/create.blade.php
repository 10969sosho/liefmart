...
<div class="container-fluid py-4">
    <div class="ds-page-header">
        <h1 class="text-gradient">Tambah Kategori Produk</h1>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="{{ route('product-categories.index') }}">Kategori Produk</a></li>
        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="ds-card-header">
                    <h6>Tambah Kategori Produk Baru</h6>
                </div>
                <div class="card-body">
                    @if ($errors->any())
