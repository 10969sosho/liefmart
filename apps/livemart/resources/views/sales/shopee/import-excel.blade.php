...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Import Data Excel Shopee Lamourad') }}</div>
                ...
                <div class="card-body">
                        ...
                        <div class="col-md-12">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('sales.platform', ['platform' => 'shopee']) }}">Platform Shopee Lamourad</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Import Excel Shopee Lamourad</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <form method="POST" action="{{ route('sales.shopee.preview-import') }}" enctype="multipart/form-data" id="shopeeImportForm">
                        @csrf
                        <div class="row mb-3">
                            <div class="col-md-12">
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6">
                                <a href="{{ route('sales.platform', ['platform' => 'shopee']) }}" class="btn btn-secondary">
                                    {{ __('Kembali') }}
                                </a>
                            </div>
