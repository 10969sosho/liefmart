...
@section('title', 'Platform Tiktok Liefmarket')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Platform Tiktok Liefmarket</h4>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Platform Tiktok Liefmarket</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="card h-100">
                                    <div class="card-body text-center">
                                        ...
                                        <p class="card-text">Input data penjualan Tiktok Liefmarket secara manual</p>
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="card h-100">
                                    <div class="card-body text-center">
                                        ...
                                        <p class="card-text">Import data penjualan Tiktok Liefmarket dari file Excel</p>
