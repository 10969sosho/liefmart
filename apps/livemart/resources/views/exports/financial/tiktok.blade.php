...
<head>
    <meta charset="utf-8">
    <title>TikTok Finance Analytics Export</title>
    <style>
        body {
...
<body>
    <div class="header">
        <h1>TIKTOK FINANCE ANALYTICS EXPORT</h1>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th style="width: 6%">HPP (Rp)</th>
                <th style="width: 5%">Biaya Admin (Rp)</th>
                <th style="width: 5%">Affiliate (Rp)</th>
                <th style="width: 5%">Shipping (Rp)</th>
                <th style="width: 5%">Voucher Fee (Rp)</th>
                <th style="width: 5%">Cashback (Rp)</th>
                ...
                <th style="width: 6%">Nominal Fix (Rp)</th>
                <th style="width: 6%">Saldo Masuk (Rp)</th>
                <th style="width: 7%">Tanggal Bayar</th>
                <th style="width: 6%">Outstanding (Rp)</th>
            </tr>
        </thead>
        <tbody>
            @php
            ...
            @foreach($transactions as $index => $transaction)
                ...
                <tr>
                    ...
                    <td class="center">{{ $transaction->qty ?? 0 }}</td>
    ...
    <div class="footer">
        ...
        <ul style="font-size: 8px; margin: 5px 0;">
            <li>Biaya Admin: Biaya administrasi platform TikTok</li>
            <li>Affiliate: Komisi affiliate marketing</li>
            <li>Shipping: Biaya pengiriman dan SFP service fee</li>
            <li>Voucher Fee: Biaya voucher extra service</li>
            <li>Cashback: Biaya cashback fee</li>
