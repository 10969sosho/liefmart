            ...
            <form method="GET" action="{{ route('analytics.sales-by-master-product-special') }}" id="filter-form" class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-6">
                            <button type="button" class="btn btn-success w-100" onclick="exportMasterProductSpecial()">
...
@include('analytics.partials.export_script', ['exportType' => 'sales_by_master_product_special'])
@endsection
...
<script>
    (function() {
        ...
        window.exportMasterProductSpecial = function() {
            ...
            dispatchExport('sales_by_master_product_special', filters);
        };
    })();
</script>
