        ...
        <div class="card-body">
            ...
            <form method="GET" action="{{ route('analytics.produk-platform-terlaris') }}" id="filter-form" class="mb-4">
                ...
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-md-2">
                        <button type="button" class="btn btn-success w-100" onclick="exportProdukPlatformTerlaris()">
...
@include('analytics.partials.export_script', ['exportType' => 'produk_platform_terlaris'])
@endsection
@push('scripts')
<script>
    ...
    window.exportProdukPlatformTerlaris = function() {
        ...
        dispatchExport('produk_platform_terlaris', filters);
    };
</script>
