...
@section('title', 'Analisis Saldo Masuk per Tanggal (1-31)')
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
            ...
            <button type="button" class="btn btn-light btn-sm" onclick="exportSalesByDateNumber()">
...
<script>
    function exportSalesByDateNumber() {
        const filters = {};
        ...
        dispatchExport('sales_by_date_number', filters);
    }
</script>
@endpush
