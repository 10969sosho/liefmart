        ...
        <div class="card-body">
            ...
            <form method="GET" action="{{ route('analytics.offline.sales-by-customer') }}" id="filter-form" class="mb-4">
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-md-2">
                        <button type="button" class="btn btn-success w-100" onclick="exportOfflineSalesByCustomer()">
...
@include('analytics.partials.export_script', ['exportType' => 'offline_sales_by_customer'])
@endsection
@push('scripts')
@if($summary['total_orders'] > 0)
<script>
...
<script>
    ...
    window.exportOfflineSalesByCustomer = function() {
        ...
        dispatchExport('offline_sales_by_customer', filters);
    };
</script>
