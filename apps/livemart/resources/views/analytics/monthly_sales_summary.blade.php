...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
            ...
            <button type="button" class="btn btn-light btn-sm" onclick="exportMonthlySalesSummary()">
            ...
            <form method="GET" action="{{ route('analytics.monthly-sales-summary') }}" id="filter-form" class="card mb-4">
                ...
                <div class="card-body">
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-md-2">
                            <button type="button" class="btn btn-success w-100" onclick="exportMonthlySalesSummary()">
...
<script>
    function exportMonthlySalesSummary() {
        const filters = {};
        ...
        if (urlParams.has('quick_range')) {
            filters.quick_range = urlParams.get('quick_range');
        }
        dispatchExport('monthly_sales_summary', filters);
    }
</script>
@endpush
