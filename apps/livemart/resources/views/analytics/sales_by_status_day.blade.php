...
@section('title', 'Analisis Saldo Masuk berdasarkan Status Hari')
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
            ...
            <button type="button" class="btn btn-light btn-sm" onclick="exportSalesByStatusDay()">
...
<script>
    function exportSalesByStatusDay() {
        const filters = {};
        ...
        dispatchExport('sales_by_status_day', filters);
    }
</script>
@endpush
