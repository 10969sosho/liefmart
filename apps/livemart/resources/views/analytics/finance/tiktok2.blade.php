            ...
            <div class="btn-group shadow-sm" role="group">
                ...
                <div class="btn-group" role="group">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow">
                        <li><button type="button" class="dropdown-item" onclick="exportFinanceTiktok2()"><i class="far fa-file-excel me-2"></i>Excel</button></li>
                    </ul>
                </div>
            </div>
        </div>
...
@include('analytics.partials.export_script', ['exportType' => 'finance_tiktok2'])
...
function exportFinanceTiktok2() {
    const form = document.querySelector('#filterModal form');
    exportWithFilters('finance_tiktok2', form);
}
</script>
@endpush
