            ...
            <div class="btn-group shadow-sm" role="group">
                ...
                <div class="btn-group" role="group">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow">
                        <li><button type="button" class="dropdown-item" onclick="exportFinanceShopee()"><i class="far fa-file-excel me-2"></i>Excel</button></li>
                    </ul>
                </div>
            </div>
        </div>
...
@include('analytics.partials.export_script', ['exportType' => 'finance_shopee'])
...
function exportFinanceShopee() {
    const form = document.querySelector('#filterModal form');
    exportWithFilters('finance_shopee', form);
}
</script>
@endpush
