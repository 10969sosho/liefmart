...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
            ...
            <button type="button" class="btn btn-light btn-sm" onclick="exportSalesByDayOfWeek()">
...
<script>
    function exportSalesByDayOfWeek() {
        const filters = {};
        ...
        // Also collect quick_range from URL if present
        const urlParams = new URLSearchParams(window.location.search);
        if (urlParams.has('quick_range')) {
            filters.quick_range = urlParams.get('quick_range');
        }
        dispatchExport('sales_by_day_of_week', filters);
    }
</script>
@endpush
