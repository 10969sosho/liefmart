...
<body>
    <div class="invoice-container">
        ...
        <div class="no-print" style="margin-top: 30px; text-align: center;">
            ...
            <button onclick="printInvoice();" style="padding: 10px 20px; background-color: #FF9800; color: white; border: none; cursor: pointer; border-radius: 4px; margin-left: 10px;">
                Cetak Langsung
            </button>
