        ...
        <div class="col-md-8">
            <div class="card">
                <div class="ds-card-header d-flex justify-content-between align-items-center">
                    <h4 class="card-title mb-0">Finance Retur Penjualan</h4>
                    <a href="{{ route('retur-penjualan.show', $retur->id) }}" class="btn btn-secondary">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('retur-penjualan.finance.process', $retur->id) }}" method="POST">
                        @csrf
