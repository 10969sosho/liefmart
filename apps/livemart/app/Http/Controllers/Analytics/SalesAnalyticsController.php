...
class SalesAnalyticsController extends Controller
{
    ...
    {
        return $this->dispatchExport('internal_product_sales', $request->all());
    }
    ...
    {
        return $this->dispatchExport('sales_export_mapped', $request->all());
    }
    ...
    {
        return $this->dispatchExport('monthly_sales_summary', $request->all());
    }
    ...
    {
        return $this->dispatchExport('sales_by_day_of_week', $request->all());
    }
    ...
    {
        return $this->dispatchExport('sales_by_date_number', $request->all());
    }
    ...
    {
        return $this->dispatchExport('sales_detail_report', $request->all());
    }
    ...
    {
        return $this->dispatchExport('sales_by_platform', $request->all());
    }
    ...
    {
        return $this->dispatchExport('sales_by_status_day', $request->all());
    }
