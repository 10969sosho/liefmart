        ...
        <div class="col-md-12">
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body">
                        ...
                        <div class="col-md-12">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb bg-light py-2 px-3 rounded">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('sales.platform', ['platform' => 'shopee2']) }}" class="text-decoration-none">Platform Shopee</a></li>
                                    <li class="breadcrumb-item"><a href="{{ route('sales.shopee2.import-excel') }}" class="text-decoration-none">Import Excel Shopee</a></li>
                    ...
                    <div class="row mt-4">
                        <div class="col-md-6">
                            <a href="{{ route('sales.shopee2.import-excel') }}" class="btn btn-secondary">
                                <i class="fas fa-arrow-left me-2"></i> Kembali
                            </a>
                        </div>
                        <div class="col-md-6 text-end">
                            @if($canProceed)
                                <form action="{{ route('sales.shopee2.process-import') }}" method="POST" class="d-inline">
                                    @csrf
