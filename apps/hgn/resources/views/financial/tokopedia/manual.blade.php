        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <span>Input Manual Data Keuangan Tokopedia</span>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('finance.tokopedia.manual-store') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" id="order_id" name="order_id" required>
                                    ...
                                    @endphp
                                    @foreach(App\Models\Order::where('platform_id', $tokopediaPlatformId)
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                <label for="nominal_diskon1" class="form-label">Komisi</label>
                                <div class="input-group">
                                    <span class="input-group-text">Rp</span>
                            ...
                            <div class="col-md-4 mb-3">
                                <label for="nominal_diskon2" class="form-label">Biaya Admin</label>
                                <div class="input-group">
                                    <span class="input-group-text">Rp</span>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                <label for="nominal_diskon3" class="form-label">Biaya Layanan</label>
                                <div class="input-group">
                                    <span class="input-group-text">Rp</span>
                            ...
                            <div class="col-md-4 mb-3">
                                <label for="nominal_diskon4" class="form-label">Ongkir</label>
                                <div class="input-group">
                                    <span class="input-group-text">Rp</span>
                            ...
                            <div class="col-md-4 mb-3">
                                <label for="nominal_diskon5" class="form-label">Diskon 5</label>
                                <div class="input-group">
                                    <span class="input-group-text">Rp</span>
