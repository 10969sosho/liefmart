...
<div class="container-fluid">
    ...
    <div class="row mb-4 align-items-center">
        <div class="col-md-6">
            ...
            <p class="text-muted small mb-0">Menampilkan riwayat perubahan untuk transaksi Blibli {{ $transaction->no_order }}</p>
        </div>
        ...
        <div class="card-body">
            ...
            <div class="alert alert-secondary mt-3">
                <div class="d-flex align-items-center">
                    ...
                    <div class="ms-auto">
                        <form action="{{ route('finance.blibli.unlock', $transaction->id) }}" method="POST">
                            @csrf
                            @method('POST')
