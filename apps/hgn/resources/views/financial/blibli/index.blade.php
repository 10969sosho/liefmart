...
@section('title', 'Blibli Financial Transactions')
...
<div class="container-fluid">
    ...
    <div class="row mb-4 align-items-center">
        <div class="col-md-6">
            <h1 class="h3 mb-0 text-gray-800">Keuangan Blibli</h1>
            <p class="text-muted small mb-0">Menampilkan data transaksi keuangan Blibli</p>
        </div>
        <div class="col-md-6 text-end">
            <div class="btn-group shadow-sm" role="group">
                <a href="{{ route('finance.blibli.import') }}" class="btn btn-success">
                    <i class="fas fa-file-upload me-1"></i> Import Excel
                </a>
                <a href="{{ route('finance.blibli.manual') }}" class="btn" style="background-color: #4e73df; color: white;">
                ...
                <div class="dropdown d-inline-block">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow">
                        <li><a class="dropdown-item" href="{{ route('finance.blibli.export.excel', request()->all()) }}"><i class="far fa-file-excel me-2"></i>Excel</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    @if(session('blibli_skipped_reasons'))
    <div class="alert alert-warning shadow-sm" role="alert">
        ...
        <div class="collapse" id="skippedReasons">
            <ul class="mb-0 ps-4">
                @foreach(session('blibli_skipped_reasons') as $reason)
                    <li>{{ $reason }}</li>
                @endforeach
            </ul>
        </div>
    ...
    <div class="row mb-4">
        <div class="col-xl-2 col-md-4 col-sm-6 mb-3">
            <div class="card dashboard-card shadow-hover h-100 border-start border-4" style="border-color: #4e73df !important;">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        <div class="text-uppercase fw-bold small" style="color: #4e73df;">Total Transaksi</div>
                        <div class="card-icon-container bg-primary-soft">
                            <i class="fas fa-receipt" style="color: #4e73df;"></i>
                        </div>
                    </div>
        ...
        <div class="col-xl-2 col-md-4 col-sm-6 mb-3">
            <div class="card dashboard-card shadow-hover h-100 border-start border-4" style="border-color: #1cc88a !important;">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        <div class="text-uppercase fw-bold small" style="color: #1cc88a;">Total Nominal Fix</div>
                        <div class="card-icon-container bg-success-soft">
                            <i class="fas fa-money-bill-wave" style="color: #1cc88a;"></i>
                        </div>
                    </div>
                    <div class="d-flex align-items-end">
                        <h3 class="fw-bold mb-0" style="color: #1cc88a;">Rp {{ number_format($totalNominalFix, 0, ',', '.') }}</h3>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-xl-2 col-md-4 col-sm-6 mb-3">
            <div class="card dashboard-card shadow-hover h-100 border-start border-4" style="border-color: #36b9cc !important;">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        <div class="text-uppercase fw-bold small" style="color: #36b9cc;">Total Saldo Masuk</div>
                        <div class="card-icon-container bg-info-soft">
                            <i class="fas fa-hand-holding-usd" style="color: #36b9cc;"></i>
                        </div>
                    </div>
                    <div class="d-flex align-items-end">
                        <h3 class="fw-bold mb-0" style="color: #36b9cc;">Rp {{ number_format($totalSaldoMasuk, 0, ',', '.') }}</h3>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-xl-2 col-md-4 col-sm-6 mb-3">
            <div class="card dashboard-card shadow-hover h-100 border-start border-4" style="border-color: #e74a3b !important;">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        <div class="text-uppercase fw-bold small" style="color: #e74a3b;">Total Outstanding</div>
                        <div class="card-icon-container bg-danger-soft">
                            <i class="fas fa-exclamation-circle" style="color: #e74a3b;"></i>
                        </div>
                    </div>
                    <div class="d-flex align-items-end">
                        <h3 class="fw-bold mb-0" style="color: #e74a3b;">Rp {{ number_format($totalOutstanding, 0, ',', '.') }}</h3>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-xl-2 col-md-4 col-sm-6 mb-3">
            <div class="card dashboard-card shadow-hover h-100 border-start border-4" style="border-color: #f6c23e !important;">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        <div class="text-uppercase fw-bold small" style="color: #f6c23e;">Order Belum Bayar</div>
                    ...
                    <div class="d-flex align-items-end">
                        ...
                        @endphp
                        <h3 class="fw-bold mb-0" style="color: #f6c23e;">{{ number_format($unpaidOrdersCount, 0, ',', '.') }}</h3>
        ...
        <div class="col-xl-2 col-md-4 col-sm-6 mb-3">
            <div class="card dashboard-card shadow-hover h-100 border-start border-4" style="border-color: #858796 !important;">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        <div class="text-uppercase fw-bold small" style="color: #858796;">Nominal Belum Bayar</div>
                        <div class="card-icon-container bg-secondary-soft">
                            <i class="fas fa-money-bill-alt" style="color: #858796;"></i>
                        </div>
                    </div>
                    <div class="d-flex align-items-end">
                        @php
                        ...
                        @endphp
                        <h3 class="fw-bold mb-0" style="color: #858796;">Rp {{ number_format($unpaidNominal, 0, ',', '.') }}</h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 fw-bold" style="color: #4e73df;">Daftar Transaksi</h6>
            @if(request()->has('from_date') || request()->has('to_date') || request()->has('from_order_date') || request()->has('to_order_date') || request()->has('order_number') || request()->has('invoice_number') || request()->has('min_nominal') || request()->has('max_nominal') || request()->has('outstanding_status'))
                <div class="d-flex align-items-center">
                    ...
                    <a href="{{ route('finance.blibli.index') }}" class="btn btn-sm btn-outline-secondary">
                            ...
                            <tbody>
                                ...
                                <tr class="bg-danger-soft">
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('finance.blibli.manual', ['order_id' => $order->id]) }}" class="btn btn-sm btn-primary">
        ...
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0 table-striped" id="payment-table">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th class="text-end" style="width: 60px;">%</th>
                            <th class="text-end" style="width: 100px;">Biaya 3</th>
                            <th class="text-end" style="width: 60px;">%</th>
                            <th class="text-end" style="width: 100px;">Biaya 4</th>
                            <th class="text-end" style="width: 60px;">%</th>
                        ...
                        @endphp
                            <tr class="{{ $rowClass }}">
                                ...
                                <td class="text-end fw-bold text-danger">
                                    @php
                                        $total_persentase = $persentase_diskon1 + $persentase_diskon2 + $persentase_diskon3 + $persentase_diskon4 + $persentase_diskon5 + $persentase_diskon6 + $persentase_diskon7 + $persentase_diskon8 + $persentase_diskon9 + $persentase_diskon10 + $persentase_diskon11 + $persentase_diskon12 + ($transaction->adjustment < 0 ? 
                                ...
                                <td class="text-end pe-3">
                                    <div class="d-flex gap-1 justify-content-end">
                                        ...
                                        <a href="{{ route('finance.blibli.history', $transaction->id) }}" class="btn btn-sm btn-outline-info" title="Riwayat Perubahan">
                                            <i class="fas fa-history"></i>
                                        </a>
                                        <a href="{{ route('finance.blibli.print-invoice', $transaction->id) }}" class="btn btn-sm btn-outline-info" target="_blank" title="Cetak Invoice">
                                            <i class="fas fa-print"></i>
                                        </a>
                                        <form action="{{ route('finance.blibli.destroy', $transaction->id) }}" method="POST" class="d-inline delete-form">
                                            @csrf
                                            @method('DELETE')
                        ...
                        <tr>
                            <td colspan="38" class="text-center py-5">
                                <div class="d-flex flex-column align-items-center">
                                    ...
                                    <p class="text-muted small">Silakan import data atau ubah filter pencarian</p>
                                </div>
                            </td>
                        </tr>
                        @endforelse
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('finance.blibli.index') }}" method="GET">
                        <div class="row">
                        ...
                        <div class="mt-4 d-flex justify-content-between">
                            ...
                            <div>
                                ...
                                <button type="submit" class="btn" style="background-color: #4e73df; color: white;">
    ...
    <div class="modal fade" id="adjustModal{{ $transaction->id }}" tabindex="-1" aria-labelledby="adjustModalLabel{{ $transaction->id }}" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('finance.blibli.adjust', $transaction->id) }}" method="POST">
                    @csrf
                    <div class="modal-body">
    ...
    document.querySelectorAll('.create-payment-btn').forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            if (confirm(`Apakah Anda ingin membuat data pembayaran untuk order ${orderNumber}?`)) {
                ...
                window.location.href = `{{ route('finance.blibli.manual') }}?order_id=${orderId}`;
            }
        });
    });
...
<style>
    ...
    /* Override for unpaid transactions */
    #payment-table tbody tr.bg-danger-soft {
        background-color: rgba(231, 74, 59, 0.5) !important;
    }
    ...
    #payment-table tbody tr.order-header td:first-child {
