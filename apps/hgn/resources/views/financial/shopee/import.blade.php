        ...
        <div class="col-md-10">
            <div class="card shadow">
                <div class="card-header d-flex justify-content-between align-items-center bg-primary text-white">
                    ...
                    <a href="{{ route('finance.shopee.index') }}" class="btn btn-light btn-sm">
                ...
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('finance.shopee.import-preview') }}" method="POST" enctype="multipart/form-data" class="mt-4">
                        @csrf
                        <div class="mb-4">
