        ...
        <div class="col-md-10">
            <div class="card shadow">
                <div class="card-header d-flex justify-content-between align-items-center bg-primary text-white">
                    <h5 class="card-title mb-0">Import Data Pembayaran Shopee</h5>
                    <a href="{{ route('finance.shopee2.index') }}" class="btn btn-light btn-sm">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-12">
                            <div class="alert alert-info">
                                ...
                                <hr>
                                <ol class="mb-0">
                                    <li class="mb-2">Buka file laporan Shopee, cari sheet "Income"</li>
                    ...
                    <form action="{{ route('finance.shopee2.import-preview') }}" method="POST" enctype="multipart/form-data" class="mt-4">
                        @csrf
                        <div class="mb-4">
