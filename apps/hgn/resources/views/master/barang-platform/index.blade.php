...
<div class="container-fluid py-4">
    <div class="ds-page-header">
        ...
        <a href="{{ route('barang-platform.create') }}" class="btn btn-primary btn-sm">
        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="ds-card-header">
                    <div>
                        <h6 class="mb-0"><i class="fas fa-boxes me-2"></i>Daftar Barang Platform</h6>
                        <p class="mb-0" style="opacity:0.85; font-size:0.8rem;">Total: {{ $platformProducts->total() }} barang platform</p>
                    </div>
                </div>
                <div class="card-body">
                    <!-- Filter Form -->
