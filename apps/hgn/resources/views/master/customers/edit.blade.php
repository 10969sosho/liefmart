        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="ds-card-header">
                    <h6 class="mb-0"><i class="fas fa-edit me-2"></i>Edit Pelanggan</h6>
                </div>
                <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('email') is-invalid @enderror" type="email" 
                                        id="email" name="email" value="{{ old('email', $customer->email == '-' ? '' : $customer->email) }}">
                                    @error('email')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('pic_name') is-invalid @enderror" type="text" 
                                        id="pic_name" name="pic_name" value="{{ old('pic_name', $customer->pic_name) }}" required>
                                    @error('pic_name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('npwp') is-invalid @enderror" type="text" 
                                        id="npwp" name="npwp" value="{{ old('npwp', $customer->npwp) }}">
                                    @error('npwp')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
