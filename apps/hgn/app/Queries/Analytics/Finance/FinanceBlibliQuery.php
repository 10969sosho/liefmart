 ...
 * FinanceBlibliQuery
 * 
 * Query untuk analytics Finance Blibli
 * Similar structure to FinanceShopeeQuery (no qty column)
 */
class FinanceBlibliQuery
{
    /**
     * Build query untuk blibli financial transactions
     */
    public static function build(array $filters = [], int $perPage = 15, int $page = 1): string
    {
        ...
        return "
            ...
            FROM blibli_financial_transactions ft
