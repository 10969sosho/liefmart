...
/**
 * FinanceTokopediaQuery
 * 
 * Query untuk analytics Finance Tokopedia
 * Similar structure to FinanceShopeeQuery
 */
class FinanceTokopediaQuery
{
    /**
     * Build query untuk tokopedia financial transactions
     */
    public static function build(array $filters = [], int $perPage = 15, int $page = 1): string
    {
        ...
        return "
            ...
            FROM tokopedia_financial_transactions ft
