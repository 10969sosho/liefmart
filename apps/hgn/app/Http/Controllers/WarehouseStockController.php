...
class WarehouseStockController extends Controller
{
     ...
     * Can be negative if barang keluar > (penerimaan + retur + penyesuaian)
     * Note: Penyesuaian hanya untuk koreksi mutasi, tidak menambah stock fisik
     */
    private function calculateRunningBalance($productId)
    {
        ...
        $totalReturPenjualanQty = \App\Models\ReturPenjualanDetail::where('product_id', $productId)->sum('qty');
        $totalReturOfflineQty = \App\Models\ReturOfflineSaleDetail::where('product_id', $productId)->sum('qty');
        ...
        // Real stock = (Penerimaan + Retur + Penyesuaian) - Barang Keluar (can be negative)
