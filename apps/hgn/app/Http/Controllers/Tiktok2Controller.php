...
public function importExcel()
{
    ...
    public function previewImport(Request $request)
    {
        ...
        try {
            ...
            if (method_exists($import, 'getInsufficientStockProducts')) {
                $insufficientStockProducts = $import->getInsufficientStockProducts();
            }
            if (method_exists($import, 'getOrdersWithStockIssues')) {
                $ordersWithStockIssues = $import->getOrdersWithStockIssues();
            }
            if (method_exists($import, 'getStockIssuesSummary')) {
                $stockIssuesSummary = $import->getStockIssuesSummary();
            }
