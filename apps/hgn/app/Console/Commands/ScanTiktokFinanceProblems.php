    ...
    private function scanPlatform($modelClass, $platformName)
    {
        ...
        foreach ($ordersWithMultipleTrans as $noOrder) {
            ...
            foreach ($transactions as $trans) {
                ...
                // HPNSDA-OLK/02 -> Kopi Non-PKP
                // HGNSDA-OL/01 -> Skincare PKP
                // HGNSDA-OL/02 -> Skincare Non-PKP
                
                $type = 'UNKNOWN';
                if (strpos($trans->no_invoice, 'HPNSDA-OLK/01') !== false) $type = 'KOPI_PKP';
                elseif (strpos($trans->no_invoice, 'HPNSDA-OLK/02') !== false) $type = 'KOPI_NONPKP';
                elseif (strpos($trans->no_invoice, 'HGNSDA-OL/01') !== false) $type = 'SKIN_PKP';
                elseif (strpos($trans->no_invoice, 'HGNSDA-OL/02') !== false) $type = 'SKIN_NONPKP';
        ...
        // Example: 011246/2509/HGNSDA-OL/01
