...
Route::prefix('sales')->middleware(['auth', 'main.category', 'prevent-back-history', 'under.construction'])->group(function () {
    ...
    Route::prefix('lazada')->group(function () {
        ...
        Route::get('/financial/export/excel', [App\Http\Controllers\Finance\LazadaFinanceController::class, 'exportExcel'])->name('finance.lazada.export.excel');
        ...
        Route::get('/financial/manual', [App\Http\Controllers\Finance\LazadaFinanceController::class, 'manual'])->name('finance.lazada.manual');
        Route::post('/financial/manual/store', [App\Http\Controllers\Finance\LazadaFinanceController::class, 'storeManual'])->name('finance.lazada.manual.store');
...
Route::prefix('retur-penjualan')
    ...
    Route::get('/search-order', [App\Http\Controllers\ReturPenjualanController::class, 'searchOrder'])->name('search-order');
