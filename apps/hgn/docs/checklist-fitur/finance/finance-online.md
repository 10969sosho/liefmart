...
Modul ini menangani rekonsiliasi dan pencatatan keuangan dari platform marketplace (Shopee, Tokopedia, Tiktok, Blibli).
...
- **Tokopedia**: `financial/tokopedia/index.blade.php`
- **Tiktok**: `financial/tiktok/index.blade.php`
- **Blibli**: `financial/blibli/index.blade.php`
- **Lazada**: `financial/lazada/index.blade.php`
