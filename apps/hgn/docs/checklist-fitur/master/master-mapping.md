...
Menghubungkan produk dari marketplace (Shopee, Tokopedia, dll) dengan Master Produk internal untuk sinkronisasi stok dan akuntansi.
...
- [ ] **UI Components**:
  - [ ] **Filter Panel**:
    - [ ] **Platform**: Dropdown (Shopee, Tokopedia, Tiktok, Lazada, Blibli).
