...
<style>
    ...
    /* Ensure navbar is not affected by our styles */
    .navbar {
...
<div class="container-fluid py-4 px-4">
    <div class="row">
        <div class="col-12">
            <div class="card mb-4 shadow-lg" style="overflow: visible; border: none; border-radius: 20px;">
                <div class="card-header pb-0" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; border-radius: 20px 20px 0 0; border: none;">
                    <div class="d-flex justify-content-between align-items-center">
                    <h6 style="font-weight: 600; font-size: 1.1rem; margin: 0;">
                        <i class="fas fa-plus-circle me-2"></i>Tambah Produk Baru
                    </h6>
                        <a href="{{ route('products.index') }}" class="btn btn-light btn-sm" style="border-radius: 20px; font-weight: 500;">
                            <i class="fas fa-arrow-left me-1"></i> Kembali
                        </a>
                </div>
                </div>
                <div class="card-body" style="overflow: visible;">
                    <form action="{{ route('products.store') }}" method="POST" id="productForm" style="overflow: visible;">
                        @csrf
                        ...
                        <div class="card mb-4 shadow-sm" style="overflow: visible; border: none; border-radius: 15px;">
                        ...
                        <div class="card mb-4 shadow-sm" style="overflow: visible; border: none; border-radius: 15px;">
                            <div class="card-header" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); color: white; border-radius: 15px 15px 0 0; border: none;">
                                <h6 class="mb-0">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-select tom-select @error('brand_id') is-invalid @enderror" 
                                        ...
                                        @endforeach
                                                ...
                                                <button type="button" class="btn" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border: none; color: white;" data-bs-toggle="modal" data-bs-target="#createBrandModal">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-select tom-select @error('sub_brand_id') is-invalid @enderror" 
                                        ...
                                        @endforeach
                                                ...
                                                <button type="button" class="btn" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); border: none; color: white;" data-bs-toggle="modal" data-bs-target="#createSubBrandModal" title="Pilih Brand terlebih dahulu">
                                                    <i class="fas fa-plus"></i>
                                                </button>
                                            </div>
                                    @error('sub_brand_id')
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-select tom-select @error('product_category_id') is-invalid @enderror" 
                                        ...
                                        @endforeach
                                                ...
                                                <button type="button" class="btn" style="background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%); border: none; color: white;" data-bs-toggle="modal" data-bs-target="#createCategoryModal" title="Pilih Sub Brand terlebih dahulu">
                                                    <i class="fas fa-plus"></i>
                                                </button>
                                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-select tom-select @error('product_type_id') is-invalid @enderror" 
                                        ...
                                        @endforeach
                                                ...
                                                <button type="button" class="btn" style="background: linear-gradient(135deg, #fa709a 0%, #fee140 100%); border: none; color: white;" data-bs-toggle="modal" data-bs-target="#createTypeModal" title="Pilih Kategori Produk terlebih dahulu">
                                                    <i class="fas fa-plus"></i>
                                                </button>
                                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-select tom-select @error('product_size_id') is-invalid @enderror" 
                                        id="product_size_id" name="product_size_id" required disabled>
                                                ...
                                                <button type="button" class="btn" style="background: linear-gradient(135deg, #a8edea 0%, #fed6e3 100%); border: none; color: #333;" data-bs-toggle="modal" data-bs-target="#createSizeModal" title="Pilih Tipe Produk terlebih dahulu">
                                                    <i class="fas fa-plus"></i>
                                                </button>
                                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-select tom-select @error('product_variant_id') is-invalid @enderror" 
                                        id="product_variant_id" name="product_variant_id" disabled>
                                                ...
                                                <button type="button" class="btn" style="background: linear-gradient(135deg, #ffecd2 0%, #fcb69f 100%); border: none; color: #333;" data-bs-toggle="modal" data-bs-target="#createVariantModal" title="Pilih Ukuran Produk terlebih dahulu">
                                                    <i class="fas fa-plus"></i>
                                                </button>
                                            </div>
                        ...
                        <!-- Harga dan Status -->
                        <div class="card mb-4 shadow-sm" style="overflow: visible; border: none; border-radius: 15px;">
                            <div class="card-header" style="background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%); color: white; border-radius: 15px 15px 0 0; border: none;">
                                <h6 class="mb-0">
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            <a href="{{ route('products.index') }}" class="btn btn-secondary" style="border-radius: 25px; padding: 10px 25px; font-weight: 500;">
                                <i class="fas fa-arrow-left me-1"></i> Kembali
                            </a>
                            <button type="submit" class="btn" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border: none; border-radius: 25px; padding: 10px 25px; font-weight: 500; color: white;">
            ...
            <form id="createBrandForm">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                            <button type="submit" class="btn" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border: none; color: white;">Simpan</button>
                        </div>
                    </form>
                </div>
            </div>
