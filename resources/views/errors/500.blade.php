...
<body>
    ...
    <div class="error-container">
        ...
        <!-- Error Title -->
        <div class="error-title">Kesalahan Server Internal</div>
        ...
        <div class="server-info">
            <h6><i class="fas fa-server me-2"></i>Informasi Server</h6>
            <p>
                Kesalahan ini terjadi pada server kami, bukan pada perangkat Anda. 
                Silakan coba lagi dalam beberapa menit atau hubungi support.
            </p>
        </div>
        ...
        <div class="action-buttons">
            ...
            <button onclick="location.reload()" class="btn btn-custom btn-danger-custom">
