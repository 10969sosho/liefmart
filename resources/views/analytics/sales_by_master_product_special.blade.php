...
<body>
            ...
            <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 text-end">
                            @if(request()->hasAny(['start_date', 'end_date', 'platform_id', 'search', 'main_categories', 'brands', 'sub_brands', 'product_categories', 'product_types', 'product_sizes', 'product_variants', 'order_number', 'sort']))
                                <a href="{{ route('analytics.sales-by-master-product-special') }}" class="btn btn-sm btn-outline-secondary">
                ...
                @if(count($productRows) > 0)
                    ...
                    <div class="alert alert-info mb-4">
                        ...
                        <p>
                            <strong>Perhitungan Gross Profit Average (Sederhana):</strong>
                        </p>
                        <ul>
                            ...
                            <li><strong>Total Modal Average:</strong> Total biaya modal rata-rata untuk semua produk</li>
                            <li><strong>Gross Profit Average:</strong> (Total Saldo Masuk - PPN) - Total Modal Average</li>
                            <li><strong>Margin:</strong> (Gross Profit Average ÷ Total Saldo Masuk - PPN) × 100%</li>
                        </ul>
                        <hr>
                        <p class="mb-0">
                            <strong>Contoh Perhitungan Gross Profit Average:</strong><br>
                            • Total Saldo Masuk: Rp 1.558.100<br>
                            • Total Saldo Masuk - PPN: Rp 1.558.100 ÷ 1.11 = Rp 1.403.693,69<br>
                            • Total Modal Average: Rp 1.284.323<br>
                            • Gross Profit Average: Rp 1.403.693,69 - Rp 1.284.323 = Rp 119.370,69<br>
                        ...
                        <table class="table table-bordered table-striped table-hover">
                            <thead class="table-dark">
                                <tr>
                                    ...
                                    <th class="text-end" style="width: 8%;">Harga Modal Average (COGS) (Rp)</th>
                            ...
                            <tbody>
                                @foreach($productRows as $row)
                                    @php
                                        // Only determine row class, no calculations - ALL DATA FROM SQL
                                        $rowClass = '';
                            ...
                            <tfoot class="table-dark">
                                <tr>
                                    ...
                                    <td class="text-end"><strong>{{ number_format($summary['total_products']) }}</strong></td>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (!urlParams.has('start_date') && !urlParams.has('end_date') && !document.referrer.includes('sales-by-master-product-special')) {
