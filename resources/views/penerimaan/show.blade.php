...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="mb-1">Detail Penerimaan</h1>
...
@push('styles')
<style>
    /* Styling khusus untuk tampilan detail penerimaan */
    .badge {
    ...
    .table th {
        background-color: rgba(181, 198, 224, 0.1);
        font-weight: 500;
    ...
    .card-header {
        background-color: rgba(181, 198, 224, 0.05);
        border-bottom: 1px solid rgba(181, 198, 224, 0.2);
    }
