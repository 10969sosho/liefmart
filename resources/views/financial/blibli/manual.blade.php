        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <span>Input Manual Data Keuangan Blibli</span>
                    <a href="{{ route('finance.blibli.index') }}" class="btn btn-sm btn-secondary">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('finance.blibli.manual-store') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" id="order_id" name="order_id" required>
                                    ...
                                    @foreach(App\Models\Order::where('platform_id', App\Models\Platform::where('name', 'blibli')->value('id'))->whereDoesntHave('blibliFinancialTransactions')->orderBy('tanggal', 'desc')->get() as $order)
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                <label for="nominal_diskon2" class="form-label">Komisi Marketplace</label>
                                <div class="input-group">
                                    <span class="input-group-text">Rp</span>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                <label for="nominal_diskon3" class="form-label">Biaya Pengiriman</label>
                                <div class="input-group">
                                    <span class="input-group-text">Rp</span>
                            ...
                            <div class="col-md-4 mb-3">
                                <label for="nominal_diskon4" class="form-label">Voucher/Diskon</label>
                                <div class="input-group">
                                    <span class="input-group-text">Rp</span>
                            ...
                            <div class="col-md-4 mb-3">
                                <label for="nominal_diskon5" class="form-label">Biaya Lainnya</label>
                                <div class="input-group">
                                    <span class="input-group-text">Rp</span>
