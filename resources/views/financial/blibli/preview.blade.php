...
@section('title', 'Preview Data Keuangan Blibli')
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h3 class="card-title">Preview Data Keuangan Blibli</h3>
                    <div class="card-tools">
                        <a href="{{ route('finance.blibli.import') }}" class="btn btn-default btn-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        <form action="{{ route('finance.blibli.import-process') }}" method="POST" class="d-inline">
                            @csrf
                            <!-- Use session token instead of sending all data via POST -->
                            <input type="hidden" name="process_token" value="{{ session('blibli_process_token', uniqid()) }}">
