    ...
    <div class="invoice-container">
        ...
        <div class="invoice-details">
            ...
            <div class="customer-info">
                <div><strong>MARKETPLACE</strong> : TIKTOK</div>
        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <td>{{ $transaction->order->orderItems->first()->platformProduct->platform_product_name ?? 'Produk TikTok' }}</td>
        ...
        <div class="totals">
            <div class="total-row">
                ...
                <div>{{ $transaction->order->orderItems->count() }} items</div>
            </div>
            <div class="total-row">
                <div><strong>Nominal Harga:</strong></div>
            ...
            <div class="total-row">
                ...
                <div>{{ number_format($transaction->nominal_fix, 0, ',', '.') }}</div>
            </div>
            <div class="total-row">
                <div><strong>Saldo Masuk:</strong></div>
                <div>{{ number_format($transaction->saldo_masuk, 0, ',', '.') }}</div>
            </div>
            <div class="total-row grand-total">
                <div><strong>OUTSTANDING:</strong></div>
                <div>{{ number_format($transaction->outstanding, 0, ',', '.') }}</div>
            </div>
        </div>
        ...
        <div class="payment-info">
            ...
            <p>Pembayaran dianggap sah apabila telah divalidasi oleh pihak keuangan dan telah diterima oleh pihak perusahaan.</p>
        </div>
