...
@section('title', 'Preview Data Keuangan Shopee')
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h3 class="card-title">Preview Data Keuangan Shopee</h3>
                    <div class="card-tools">
                        <a href="{{ route('finance.shopee2.import') }}" class="btn btn-default btn-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        <form action="{{ route('finance.shopee2.import-process') }}" method="POST" class="d-inline">
                            @csrf
                            <!-- Use session token instead of sending all data via POST -->
                            <input type="hidden" name="process_token" value="{{ session('shopee2_process_token', uniqid()) }}">
                            
                            <button type="submit" class="btn btn-success" {{ $validRows == 0 ? 'disabled' : '' }}>
                                <i class="fas fa-check"></i> Proses {{ $validRows }} Data Valid
                            </button>
                            
                            <a href="{{ route('finance.shopee2.import') }}" class="btn btn-secondary">
                                <i class="fas fa-arrow-left"></i> Kembali
                            </a>
                        </form>
                    </div>
