...
@section('page-title', 'Import Arus Kas Tiktok Liefmarket')
        ...
        <div class="col-12">
            <div class="card shadow-sm">
                <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                    <h5 class="mb-0 fw-bold">Import Data Arus Kas Tiktok Liefmarket</h5>
                    <a href="{{ route('finance.aruskastiktok2.index') }}" class="btn btn-sm btn-outline-secondary">
                ...
                <div class="card-body">
                        ...
                        <div class="col-md-12">
                            <div class="alert alert-info bg-light-info border-start border-info border-4">
                                ...
                                <div class="alert alert-info">
                                    ...
                                    <strong>Tip:</strong> Gunakan fitur "Excel Arus Kas" dari halaman <a href="{{ route('finance.tiktok.index') }}" class="alert-link">Finance TikTok</a> untuk menghasilkan file dengan format yang tepat.
                                </div>
                                <div class="alert alert-warning">
                                    <i class="fas fa-exclamation-triangle me-2"></i>
                                    <strong>Penting:</strong> Pastikan file Excel Anda mencakup semua jenis transaksi termasuk:
                                    <ul class="mb-0 mt-2">
                                        <li><strong>Penghasilan dari pesanan</strong> - dengan nomor pesanan</li>
                                        <li><strong>Penarikan Dana Ke Rekening</strong> - tanpa nomor pesanan (akan otomatis diisi dengan "-")</li>
                                    </ul>
                                </div>
                                <div class="alert alert-info">
                                    <i class="fas fa-info-circle me-2"></i>
                                    <strong>Tips untuk Nomor Pesanan:</strong> Jika nomor pesanan sangat panjang, pastikan kolom "No. Pesanan" di Excel diformat sebagai <strong>Text</strong> untuk mencegah perubahan angka.
                                </div>
                                <div class="alert alert-success">
                                    <i class="fas fa-check-circle me-2"></i>
                                    <strong>Aturan Duplicate:</strong> 
                                    <ul class="mb-0 mt-2">
                                        <li><strong>Diperbolehkan:</strong> Nomor pesanan sama dengan deskripsi berbeda</li>
                                        <li><strong>Diperbolehkan:</strong> Nomor pesanan sama dengan tanggal/nilai berbeda</li>
                                        <li><strong>Ditolak:</strong> Hanya data yang 100% identik (semua kolom sama persis)</li>
                                    </ul>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <ul class="list-group list-group-flush">
                                                    ...
                                                    <li class="list-group-item bg-transparent"><i class="fas fa-star text-warning me-2"></i> <strong>No. Pesanan</strong> - Nomor pesanan dari TikTok</li>
                                                </ul>
                                            </div>
                                            <div class="col-md-6">
                                                <ul class="list-group list-group-flush">
                    ...
                    <div class="card shadow-sm border-0 bg-light-subtle mb-4">
                        <div class="card-body">
                            <form action="{{ route('finance.aruskastiktok2.preview') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-7">
                                        <div class="form-group mb-3">
                                            <label for="file" class="form-label fw-medium">File Excel Arus Kas Tiktok Liefmarket</label>
