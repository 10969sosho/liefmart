...
@section('page-title', 'Preview Import Arus Kas Tiktok Lamourad')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Preview Data Arus Kas Tiktok Lamourad</h4>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="mt-4 card bg-light shadow-sm border-0">
                        <div class="card-body">
                            <form id="processForm" action="{{ route('finance.aruskastiktok.process') }}" method="POST">
                                @csrf
                                <input type="hidden" name="import_session_id" value="{{ $import_session_id ?? '' }}" id="importSessionId">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <a href="{{ route('finance.aruskastiktok.import') }}" class="btn btn-secondary">
