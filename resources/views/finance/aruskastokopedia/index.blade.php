        ...
        <div class="col-12">
            <div class="card shadow-sm">
                <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                    <h5 class="mb-0 fw-bold">Data Arus Kas Tokopedia</h5>
                    <div>
...
<style>
    ...
    .table th.tipe-col, .table td.tipe-col {
        width: 120px;
        text-align: center;
    }
    ...
    .table th.nominal-col, .table td.nominal-col,
    .table th.balance-col, .table td.balance-col {
        width: 120px;
        text-align: right;
    }
