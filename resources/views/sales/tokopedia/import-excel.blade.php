...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Import Data Excel Tokopedia') }}</div>
                ...
                <div class="card-body">
                        ...
                        <div class="col-md-12">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('sales.platform', ['platform' => 'tokopedia']) }}">Platform Tokopedia</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Import Excel Tokopedia</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-12">
                            <div class="card mb-4">
                                <div class="card-body">
                                    <h5 class="card-title">Instruksi Import Excel Tokopedia</h5>
                                    <hr>
                    ...
                    <form method="POST" action="{{ route('sales.tokopedia.preview-import') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-3">
                            <div class="col-md-12">
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6">
                                <a href="{{ route('sales.platform', ['platform' => 'tokopedia']) }}" class="btn btn-secondary">
                                    {{ __('Kembali') }}
                                </a>
                            </div>
