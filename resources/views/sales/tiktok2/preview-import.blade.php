            ...
            <div class="col-md-12">
                <div class="card shadow-sm border-0 mb-4">
                    ...
                    <div class="card-body">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb bg-light py-2 px-3 rounded">
                                        ...
                                        <li class="breadcrumb-item"><a
                                                href="{{ route('sales.platform', ['platform' => 'tiktok2']) }}"
                                                class="text-decoration-none">Platform TikTok</a></li>
                                        <li class="breadcrumb-item"><a href="{{ route('sales.tiktok2.import-excel') }}"
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <h5 class="mb-0 fw-bold">{{ isset($duplicateOrders) && is_array($duplicateOrders) ? count($duplicateOrders) : 0 }}</h5>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        @if (isset($duplicateOrders) && is_array($duplicateOrders) && count($duplicateOrders) > 0)
                            <div class="alert alert-info alert-dismissible fade show" role="alert">
                                <h5 class="alert-heading d-flex align-items-center">
                                                ...
                                                @php
                                                    ...
                                                    foreach ($data as $item) {
                                                        ...
                                                        $orderTotals[$item['no_order']] +=
                                                            $item['qty'] * ($item['harga_setelah_diskon'] ?? $item['harga'] ?? 0);
                                                    }
                                                @endphp
                                                ...
                                                @foreach ($orderItems as $orderNumber => $items)
                                                    ...
                                                    @foreach ($items as $index => $item)
                                                        <tr class="{{ $rowClass }} {{ $index === 0 ? 'new-order' : '' }}">
                                                            ...
                                                            <td class="text-end">
                                                                {{ number_format($item['harga_setelah_diskon'] ?? $item['harga'] ?? 0, 0, ',', '.') }}
                                                            </td>
                                                            <td class="text-end">
                                                                {{ number_format($item['qty'] * ($item['harga_setelah_diskon'] ?? $item['harga'] ?? 0), 0, ',', '.') }}
                                                            </td>
                        ...
                        <div class="row mt-4">
                            <div class="col-md-6">
                                <a href="{{ route('sales.tiktok2.import-excel') }}" class="btn btn-secondary">
                                    <i class="fas fa-arrow-left me-2"></i> Kembali
                                </a>
                            </div>
                            <div class="col-md-6 text-end">
                                @if ($canProceed && count($data) > 0)
                                    <form action="{{ route('sales.tiktok2.process-import') }}" method="POST"
                                        class="d-inline">
                                        @csrf
