                ...
                <div class="d-flex align-items-center mb-3">
                    <div class="flex-shrink-0">
                        <div class="stat-icon rounded d-flex align-items-center justify-content-center" 
                            ...
                            <i class="fas fa-shopping-bag text-secondary" style="font-size: 1.2rem;"></i>
                        </div>
                    </div>
                ...
                <div class="d-flex align-items-center mb-3">
                    <div class="flex-shrink-0">
                        <div class="stat-icon rounded d-flex align-items-center justify-content-center" 
                            ...
                            <i class="fas fa-music text-accent" style="font-size: 1.2rem;"></i>
                        </div>
                    </div>
                    <div class="flex-grow-1 ms-3">
